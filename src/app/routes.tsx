    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="flex">
        <Sidebar 
                  ...
                  isMobile={isMobile} activeTab={''} onNavigate={function (): void {
                      throw new Error('Function not implemented.');
                  } }        />
...
export const router = createBrowserRouter([
  {
    ...
    element: <AppLayout />,
    children: [
      { path: '', element: <Home onNavigate={function (page: string, postId?: string): void {
          throw new Error('Function not implemented.');
      } } searchQuery={''} /> },
      { path: 'post/:postId', element: <PostDetailPage postId={''} currentUser={undefined} onNavigate={function (page: string, postId?: string): void {
          throw new Error('Function not implemented.');
      } } /> }, // Dynamic route
      { path: 'library', element: <Library onNavigate={function (_page: string): void {
          throw new Error('Function not implemented.');
      } } /> },
      { path: 'stories', element: <Stories onNavigate={function (_page: string): void {
          throw new Error('Function not implemented.');
      } } /> },
      { path: 'profile/:userId?', element: <Profile onNavigate={function (_page: string): void {
          throw new Error('Function not implemented.');
      } } /> },
      { path: 'following', element: <Following onNavigate={function (_page: string): void {
          throw new Error('Function not implemented.');
      } } /> },
